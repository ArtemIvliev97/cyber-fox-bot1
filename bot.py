...
ANALYSIS_PROMPT = (
    ...
    "Разбери его по пунктам и обязательно укажи числовые оценки:\n"
    "- Экспозиция, пересветы/недосветы.\n"
    "- Контраст.\n"
    "- Цветовой баланс (оценочная температура в К).\n"
    "- Шум.\n"
    "- Резкость.\n"
    "- Композиция и кадрирование.\n"
    "Для каждой проблемы дай конкретный совет. Пиши в стиле Ари."
)
